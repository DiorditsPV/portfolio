...
const GROUPS = [
  ...
  {
    topic: 'product', ru: 'Свои проекты',
    note: 'Собственные сервисы изнутри: какая задача решалась, как устроено и какие решения оказались важными. Разбор пишется по репозиторию и работающему сервису, а не по замыслу.',
  },
  {
