...
- `resume.pdf` — кнопка «Скачать резюме» ведёт на файл с этим именем рядом с `index.html`;
  положи туда своё резюме или убери кнопку из hero-секции.
- Telegram в `T.socials` — сейчас заглушка `https://t.me/`, подставь ник.
